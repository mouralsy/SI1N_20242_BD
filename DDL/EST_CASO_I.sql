...
PROD_ESPECTEC VARCHAR(50) NOT NULL,
...
PED_PREVISAO VARCHAR(20) NOT NULL,
...
ALTER TABLE FORNECEDORES ADD FORNEC_CODPOSTAL VARCHAR(10) NOT NULL;
ALTER TABLE FORNECEDORES DROP COLUMN FORNEC_RUA VARCHAR(45) NOT NULL;
ALTER TABLE FORNECEDORES MODIFY COLUMN FORNEC_NUMRUA INT NOT NULL;
ALTER TABLE FORNECEDORES CHANGE COLUMN FORNEC_COD FORNEC_ID INT PRIMARY KEY;

ALTER TABLE FILIAIS ADD FILIAL_CEP INT NOT NULL;
ALTER TABLE FILIAIS DROP COLUMN FILIAL_RUA VARCHAR(100) NOT NULL;
ALTER TABLE FILIAIS MODIFY COLUMN FILIAL_NUMRUA INT NOT NULL;
ALTER TABLE FILIAIS CHANGE COLUMN FILIAL_COD FILIAL_ID INT PRIMARY KEY;

ALTER TABLE PRODUTOS ADD PROD_FORN VARCHAR(50) NOT NULL;
ALTER TABLE PRODUTOS DROP COLUMN PROD_DESCRICAO TEXT NOT NULL;
ALTER TABLE PRODUTOS MODIFY COLUMN PROD_ESPECTEC TEXT NOT NULL;
ALTER TABLE PRODUTOS CHANGE COLUMN PROD_PRECO PROD_PRECOUNIT DECIMAL(10,2) NOT NULL;

ALTER TABLE PEDIDOS ADD PED_DATAHORA DATETIME NOT NULL;
ALTER TABLE PEDIDOS DROP COLUMN PED_DATA DATE NOT NULL, PED_HORA TIME NOT NULL;
ALTER TABLE PEDIDOS MODIFY COLUMN PED_PREVISAO DATE NOT NULL;
ALTER TABLE PEDIDOS CHANGE COLUMN PED_CODIGO PED_COD INT PRIMARY KEY;

ALTER TABLE RECEBIMENTOS ADD RECEB_DATAHORA DATETIME NOT NULL;
ALTER TABLE RECEBIMENTOS DROP COLUMN  RECEB_DATA DATE NOT NULL, RECEB_HORA TIME NOT NULL;
ALTER TABLE RECEBIMENTOS MODIFY COLUMN RECEB_QUANT_PROD INT NOT NULL;
ALTER TABLE RECEBIMENTOS CHANGE COLUMN RECEB_CONDICAO RECEB_ESPEC TEXT NOT NULL;
